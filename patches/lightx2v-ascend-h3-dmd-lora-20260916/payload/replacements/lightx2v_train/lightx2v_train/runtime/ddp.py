...
from lightx2v_train.runtime.accelerator import get_accelerator, get_accelerator_type
...
def _ddp_kwargs(config):
    ...
    if get_accelerator_type() != "cpu":
        ...
        kwargs["device_ids"] = [current_device]
        kwargs["output_device"] = current_device
    return kwargs
